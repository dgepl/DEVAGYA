...
export function ExamPrepStudio() {
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-6 pb-40 md:pb-16 px-2 sm:px-4">
          ...
          <div className="bg-white/10 backdrop-blur-xl border border-white/15 p-4 sm:p-5 rounded-2xl flex items-center gap-4 shrink-0 shadow-lg">
              ...
              <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-full border-4 border-white/10 flex items-center justify-center">
                <div className="text-center">
                  <span className="text-xl sm:text-2xl font-black text-amber-300">
                    {examData ? `${examData.confidence_score || 85}%` : "--"}
                  </span>
                </div>
              </div>
            </div>
            <div>
              ...
              <div className="text-sm font-black text-white mt-0.5">
                {examData ? "Board Distinction Target" : "Configure & Generate"}
              </div>
              <div className="text-[10px] text-emerald-300 font-semibold mt-0.5 flex items-center gap-1">
                <CheckCircle2 className="w-3 h-3 text-emerald-400" /> {examData ? "Syllabus Aligned" : "AI Powered Blueprint"}
              </div>
            </div>
          </div>
        </div>
      ...
      {/* ============================================================ */}
      {/* 3. MAIN RESULTS / EMPTY / LOADING STATE                      */}
      {/* ============================================================ */}
      {loading ? (
        <div className="bg-white rounded-3xl p-8 sm:p-12 border border-slate-200 text-center space-y-4 shadow-sm animate-in fade-in duration-300">
          <div className="w-16 h-16 rounded-2xl bg-gradient-to-tr from-rose-500 to-indigo-600 text-white flex items-center justify-center mx-auto shadow-lg shadow-rose-500/20 animate-pulse">
            <Sparkles className="w-8 h-8" />
          </div>
          <div className="space-y-1.5">
            <h3 className="text-lg font-black text-slate-900">
              Building Your {daysRemaining}-Day Exam Strategy...
            </h3>
            <p className="text-xs sm:text-sm text-slate-500 max-w-md mx-auto leading-relaxed">
              Analyzing CBSE NCERT curriculum for <span className="font-bold text-slate-800">{selectedClass} • {subject}</span>, identifying high-yield weightage chapters, and drafting your day-by-day revision roadmap.
            </p>
          </div>
          <div className="flex items-center justify-center gap-2 text-xs font-bold text-rose-600 pt-2">
            <RefreshCw className="w-4 h-4 animate-spin" />
            <span>Synthesizing syllabus & scoring predictions...</span>
          </div>
        </div>
      ) : !examData ? (
        <div className="bg-white rounded-3xl p-6 sm:p-10 border border-slate-200/90 shadow-sm text-center space-y-6 animate-in fade-in duration-300">
          ...
          <div className="space-y-2 max-w-lg mx-auto">
            <h3 className="text-lg sm:text-xl font-black text-slate-900">
              Ready to Build Your {selectedClass} Exam Strategy
            </h3>
            <p className="text-xs sm:text-sm text-slate-500 leading-relaxed font-medium">
              Select your Grade, Subject, Syllabus Focus, and Countdown Days above, then click <span className="font-bold text-rose-600">"Build Exam Strategy"</span> to generate your personalized NCERT revision blueprint.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 max-w-4xl mx-auto text-left">
            <div className="p-4 rounded-2xl bg-slate-50 border border-slate-200/80 space-y-1.5">
              ...
              <div className="text-xs font-black text-slate-900">High-Yield Topics</div>
              <p className="text-[11px] text-slate-500 font-medium">Prioritized NCERT chapters with official marks weightage.</p>
            </div>
            ...
            <div className="p-4 rounded-2xl bg-slate-50 border border-slate-200/80 space-y-1.5">
              ...
              <div className="text-xs font-black text-slate-900">{daysRemaining}-Day Roadmap</div>
              <p className="text-[11px] text-slate-500 font-medium">Full day-by-day revision schedule tailored to your countdown.</p>
            </div>
            ...
            <div className="p-4 rounded-2xl bg-slate-50 border border-slate-200/80 space-y-1.5">
              ...
              <div className="text-xs font-black text-slate-900">Predicted Questions</div>
              <p className="text-[11px] text-slate-500 font-medium">Likely board questions with step-by-step scoring outlines.</p>
            </div>
            ...
            <div className="p-4 rounded-2xl bg-slate-50 border border-slate-200/80 space-y-1.5">
              ...
              <div className="text-xs font-black text-slate-900">Evaluator Secrets</div>
              <p className="text-[11px] text-slate-500 font-medium">Pro examiner tips to maximize your board distinction score.</p>
            </div>
          </div>
          ...
          <div className="pt-2">
            <button
              ...
              disabled={loading}
              className="px-8 py-3.5 bg-gradient-to-r from-rose-600 via-purple-600 to-indigo-600 hover:from-rose-700 hover:to-indigo-700 active:scale-98 text-white font-black text-xs sm:text-sm rounded-2xl shadow-xl shadow-rose-600/20 transition-all inline-flex items-center gap-2 cursor-pointer"
            >
              <Sparkles className="w-4 h-4 text-amber-300" />
              <span>Build Strategy for {selectedClass} • {daysRemaining} Days</span>
