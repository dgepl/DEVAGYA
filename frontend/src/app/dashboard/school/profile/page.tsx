  ...
  return (
    <div className="space-y-4 pb-28">
      ...
      <div className="text-center p-4 bg-indigo-50/50 border border-indigo-100 rounded-2xl text-xs text-indigo-950 flex items-center justify-center gap-2">
        ...
        <span>Need help with school setup? Contact <a href="mailto:dgepl.info@gmail.com" className="font-extrabold text-indigo-700 underline hover:text-indigo-900">dgepl.info@gmail.com</a></span>
      </div>
    </div>
  );
}
